// controller_uno_r4_v2/main.cpp
// ----------------------------------------------------------------------
// Variant control scheme — does NOT replace controller_uno_r4/main.cpp.
//
...
//
// Build: pio run -e controller_uno_r4_v2 -t upload
// ----------------------------------------------------------------------
...
void setup() {
    ...
    Serial.println(F("[ctl-v2] boot OK — sticks=shoulder/elbow, SW=base spin, pot=claw"));
    Serial.println(F("[ctl-v2] cmds: h=home  b<deg>=base  s<deg>=shoulder  e<deg>=elbow  c<deg>=claw"));
